...
const ground = BABYLON.MeshBuilder.CreateGround("ground", { width: 20, height: 35}, scene);
...
function drawPointMarker(point) {
    ...
    // Creating point
    var shapeNum = shapesToExtrude.length;
    var sphereNumInShape = points.length - 1;
    var sphere = BABYLON.MeshBuilder.CreateSphere("pointMarker" + shapeNum.toString() + "_" + sphereNumInShape.toString(), { diameter: 0.5}, scene);
